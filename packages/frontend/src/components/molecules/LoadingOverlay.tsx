...
export const useLoadingOverlay = () => {
  const [isLoadingOverlayDiplay, setIsLoadingOverlayDisplay] = React.useState(false);
  const closeLoadingOverlay = () => {
    setIsLoadingOverlayDisplay(false);
  };
  const openLoadingOverlay = () => {
    setIsLoadingOverlayDisplay(true);
  };
  return { isLoadingOverlayDiplay, closeLoadingOverlay, openLoadingOverlay };
};
